...
public class EditProgram {
	...
	public void admin_change_the_program_status() {
	...
	public void admin_enter_invalid_and_$_and_click_on_save_button(Integer int1) {
	...
	public void admin_enter_invalid_and_$re34_and_click_on_save_button() {
	     
	     
	}

	@When("Admin click on the cancel button on Program window popup")
	public void admin_click_on_the_cancel_button_on_program_window_popup() {
